...
class UserModel extends Model implements IModel {
    ...
    public function getAll(){
        ...
        try{
            ...
            while($p = $query->fetch(PDO::FETCH_ASSOC)){
                ...
                $item->setPasswordGetAll($p['password']);
                $item->setRole($p['role']);
    ...
    public function get($id){
        ...
        try{
            ...
            $this->setPasswordGetAll($user['password']);
    ...
    public function update(){
        try{error_log('USERMODEL:: update-> id ' .$this->id.' name '.$this->name.' username '.$this->username);
    ...
    ////--------- metodos exclusivos de usermodel-------
    ...
    public function setPasswordGetAll($password)  {   $this->password	=	$password;}
