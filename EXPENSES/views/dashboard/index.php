                        ...
                        <div class="card w-50">
                            ...
                            <?php
                                    if ($totalThisMonth === NULL) {
                                        ...
                                        <span >
                                            <?php $gap = $user->getBudget()- $totalThisMonth;
                                            if($gap < 0){
                        ...
                        <div class="card w-50">
                            ...
                            <?php
                                    if ($maxExpensesThisMonth === NULL) {
                                        ...
                                        <span >$
                                            <?php echo number_format($maxExpensesThisMonth,2);
                                            ?>
                                             </span>
                                  <?php    }?>
                ...
                <div id="expenses-category">
                    ...
                    <div id="categories-container">
                        <?php
                            ...
                            } else {error_log("view/dashboard/index::expenses-category -> numero de categories ".count($categories));
                                foreach ($categories as $category) { 
                                    error_log("view/dashboard/index::expenses-category -> carga view de Dashboard ".$category['category']->getName());
                                    ?>
                ...
                <div class="transactions-container">
                    ...
                    ?>
                        <div class="more-container">
                            <a href="<?php echo constant('URL'); ?>expenses">Ver todos los gastos<i class="material-icons">keyboard_arrow_right</i></a>
                        </div>
                    </section>
                </div>
            </div>
